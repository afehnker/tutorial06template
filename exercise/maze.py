...
class Maze:
    """
    Generates a grid based exercise based on GridElements
    ...
    """
    Initializes the grid with which the exercise will be generated
    ...
    """
    Resets the GridElements of the exercise
    """
    ...
    """
    Resets the state of the GridElements of the exercise
    """
    ...
    """
    Draw every GridElement in the exercise
    """
    ...
    """
     Generate the exercise based on depth first search 
     """
